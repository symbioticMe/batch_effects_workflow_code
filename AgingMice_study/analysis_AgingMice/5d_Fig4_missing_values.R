...
if (!'heatmap_75_normalized_clustered.png' %in% list.files('plots_AgingMice/png_for_plots')) {
...
ggsave(gg_Fig4, 
       filename = 'plots_AgingMice/Fig4_missing_values1.pdf', 
       dev = cairo_pdf, width = 17.79, height = 8.96)
