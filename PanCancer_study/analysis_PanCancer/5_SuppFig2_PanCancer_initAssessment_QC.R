...
color_list_PanCancer = sample_annotation_to_colors(sample_annotation = sample_annotation_PanCancer,
                                                   ...
                                                   factor_columns = c('digestion_batch', 'tissue', 'case_control', 'patient_ID'))
...
boxlot_PanCancer_raw = plot_boxplot(proteome_raw, 
                                     ...
                                     order_col = NULL,color_by_batch = T, batch_col = 'digestion_batch',
                                     color_scheme = color_list_PanCancer[['digestion_batch']])+
...
###=========2. clustering (better after protein quantification, though)===============
factors_to_plot = c('digestion_batch', "tissue", "case_control")
...
panel_heatmaps = ggarrange(heatmap_norm$gtable %>%
                           ...
                           heatmap_corrected$gtable, ncol = 2, labels = c('C','D'))

###=========3. Protein-level Spike-in plotting (panels C and D)================
